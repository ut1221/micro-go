...
var file_api_system_v1_auth_proto_rawDesc = []byte{
	...
	0x72, 0x42, 0x2d, 0x0a, 0x0d, 0x61, 0x70, 0x69, 0x2e, 0x73, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x2e,
	0x76, 0x31, 0x50, 0x01, 0x5a, 0x1a, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2f, 0x61, 0x70, 0x69, 0x2f,
...
var file_api_system_v1_auth_proto_goTypes = []interface{}{
...
func file_api_system_v1_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_system_v1_auth_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Router); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_system_v1_auth_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_system_v1_auth_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
