...
func RegisterAuthHTTPServer(s *http.Server, srv AuthHTTPServer) {
	...
	r.GET("/captchaImage", _Auth_Captcha0_HTTP_Handler(srv))
	r.POST("/login", _Auth_Login0_HTTP_Handler(srv))
	r.GET("/getInfo", _Auth_UserInfo0_HTTP_Handler(srv))
	r.GET("/getRouters", _Auth_Routers0_HTTP_Handler(srv))
